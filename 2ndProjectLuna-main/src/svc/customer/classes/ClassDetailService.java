...
public class ClassDetailService {
	...
	public JjimBean getJjimBean(int CL_ID, String userId) throws Exception{
	...
	public String getWriter(int CL_ID) throws Exception{
		String writer = null;
		Connection con = getConnection();
		CustomerDAO customerDAO = CustomerDAO.getInstance();
		customerDAO.setConnection(con);
		writer = customerDAO.getWriter(CL_ID);
