...
import svc.customer.classes.JjimCancelDetailService;
...
public class JjimCancelDetailAction implements Action {

	public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{ 
		HttpSession session = request.getSession();
		
		JjimCancelDetailService jjimCancelDetailService = new JjimCancelDetailService();
		...
		JjimBean jjimBean = jjimCancelDetailService.getDeleteJjimBean(CL_ID, userId);
