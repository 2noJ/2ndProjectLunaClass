...
import svc.customer.myClass.MyClassListINGService;
import vo.ActionForward;
import vo.ClassBean;
import vo.PageInfo;
import vo.User;

public class MyClassListINGAction implements Action {
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		MyClassListINGService myClassListService = new MyClassListINGService();
		...
		forward.setPath("/view/customer/myClass/myClassListING.jsp");
		return forward;
