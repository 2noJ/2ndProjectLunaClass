...
import svc.customer.myClass.MyClassListEndService;
import vo.ActionForward;
import vo.ClassBean;
import vo.PageInfo;
import vo.User;

public class MyClassListEndAction implements Action {
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		MyClassListEndService myClassListService = new MyClassListEndService();
		...
		forward.setPath("/view/customer/myClass/myClassListEnd.jsp");
		return forward;
