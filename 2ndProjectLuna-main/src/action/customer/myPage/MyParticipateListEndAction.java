...
import svc.customer.myPage.MyParticipateListEndService;
import vo.ActionForward;
import vo.ClassBean;
import vo.PageInfo;
import vo.User;

public class MyParticipateListEndAction implements Action {
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		MyParticipateListEndService myParticipateListService = new MyParticipateListEndService();
		...
		forward.setPath("/view/customer/myPage/myParticipateListEnd.jsp");
		return forward;
