		...
		<div class="row">
			...
			<br>
				<div id="profile-group">
					...
					<div>프로필 사진</div>
					<div>
						<form action="profilePicUpdate.do?CUS_ID=<%=myInfo.getCUS_ID()%>&page=<%=request.getParameter("page") %>"
				...
				<div class="item-group row">
					...
					<div class="col-md-7">
						<input type="text" id="change-phone" class="noBorder mb-3"
							placeholder="<%=myInfo.getCUS_TEL()%>"
							disabled="disabled" ></input>
						<div id="change-tel" class="collapse">
							<form action="telUpdate.do" method="post" class="needs-validation" novalidate>
								<div>
									<div class="form-group">
